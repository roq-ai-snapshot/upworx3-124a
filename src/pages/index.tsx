  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Upworx3, your all-in-one platform for company owners, recruiters, and freelancers. Streamline company account creation, job offers, applications, and contract handling. Reinvent your work experience with us."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Upworx3, your all-in-one platform for company owners, recruiters, and freelancers. Streamline company account creation, job offers, applications, and contract handling. Reinvent your work experience with us.`}
            </Text>
            <Box
